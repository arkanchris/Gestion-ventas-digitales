...
class StreamControlApp(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        # Sidebar
        self.sidebar = ctk.CTkFrame(self, width=220, fg_color=self.colors["bg_sidebar"], corner_radius=0)
        self.sidebar.grid(row=0, column=0, sticky="nsew")
        self.sidebar.grid_rowconfigure(20, weight=1)
        self.sidebar.grid_propagate(False)

        # Logo area
        logo_frame = ctk.CTkFrame(self.sidebar, fg_color="#0d0f1a", corner_radius=0, height=80)
        ...
        ver_label.grid(row=21, column=0, pady=10)

        # Main content area
        self.content_frame = ctk.CTkFrame(self, fg_color=self.colors["bg_dark"], corner_radius=0)
